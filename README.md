...
<div align="center">
 ...
 <!-- LOGO -->
  ...
  <img src="./src/assets/auto-complete.JPG" alt="logo" width="160"  height="auto" />
  <br/>

<!-- MAIN HEADING -->

  <h3><b>Search Auto Complete</b></h3>
...
<!-- INTRO -->
# 📖 Search Auto Complete<a name="about-project"></a>

> Search Auto Complete is an interactive app that fetches data from an API endpoint. When the user types to search, suggestions are displayed in a dropdown for the user to select from the list.
...
> - Display list suggestions on search
...
> 
```sh
cd search-auto-complete
https://github.com/anyars-encarta/search-auto-complete.git
```
